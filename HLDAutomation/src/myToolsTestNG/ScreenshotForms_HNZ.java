...
public class ScreenshotForms_HNZ {
	// Customise for each website
	//**********************************************************************************
	private static String myVehicle="Trax";
	...
	public static void setUp() throws Exception {
		...
		// Forms under Test
		/*
		AllURLs.add("http://preprod.holden.co.nz/buildprice/vehicles"); // Done
		AllURLs.add("http://preprod.holden.co.nz/forms/view-brochures?Vehicle="+myVehicle);//
		AllURLs.add("http://preprod.holden.co.nz/forms/request-a-test-drive?Vehicle="+myVehicle);//Done
		AllURLs.add("http://preprod.holden.co.nz/forms/get-a-quote?Vehicle="+myVehicle);//Done
		AllURLs.add("http://preprod.holden.co.nz/about/innovation/mylink/"+myVehicle);//Done
		AllURLs.add("http://preprod.holden.co.nz/ownership/bluetooth/bluetooth-compatibility");//Done
		 */
	}
	...
	public void A_Test_BuildPrice() throws Exception {
		myURL="http://"+myEnv+".holden.co.nz/buildprice/vehicles";
		driver.get(myURL);
		//testname= name.getMethodName();System.out.println(testname);
		...
		try {
			...
			while(!(driver.findElement(By.xpath("//div[7]/div/div/div/div[2]/a")).isDisplayed()))
			{
	...
	public void B_Test_RequestTestDrive() throws Exception {
		myURL="http://"+myEnv+".holden.co.nz/forms/request-a-test-drive?Vehicle="+myVehicle;
		driver.get(myURL);//testname= name.getMethodName();System.out.println(testname);
		WriteToFile.myWriteAppend(errorlog,"Scanning for 404,500, Redirection and network errors on Forms for new vehicle: "+myURL); // functionality in CheckTitle.CheckErrorsComplete Method
		int flag =0;
		if (myURL.contains(".com.au"))
		{
		...
		try{
			...
			driver.findElement(By.xpath("//form/div[2]/div[7]/div/input")).sendKeys("3037");
			FormData=FormData+"Postcode: 3037 ";
			Thread.sleep(5000);
	...
	public void C_Test_GetQuote() throws Exception {
		myURL="http://"+myEnv+".holden.co.nz/forms/get-a-quote?Vehicle="+myVehicle ;
		driver.get(myURL);//testname= name.getMethodName();System.out.println(testname);
		WriteToFile.myWriteAppend(errorlog,"Scanning for 404,500, Redirection and network errors on Forms for new vehicle: "+myURL); // functionality in CheckTitle.CheckErrorsComplete Method
		int flag =0;
		if (myURL.contains(".com.au"))
	...
	public void D_Test_Mylink() throws Exception {
		myURL="http://"+myEnv+".holden.co.nz/about/innovation/mylink/"+myVehicle;
		driver.get(myURL);//testname= name.getMethodName();System.out.println(testname);
		WriteToFile.myWriteAppend(errorlog,"Scanning for 404,500, Redirection and network errors on Forms for new vehicle: "+myURL); // functionality in CheckTitle.CheckErrorsComplete Method
		int flag =0;
		if (myURL.contains(".com.au"))
	...
	public void E_Test_Bluetooth() throws Exception {
		myURL="http://"+myEnv+".holden.co.nz/ownership/bluetooth/bluetooth-compatibility";
		driver.get(myURL);//testname= name.getMethodName();System.out.println(testname);
		WriteToFile.myWriteAppend(errorlog,"Scanning for 404,500, Redirection and network errors on Forms for new vehicle: "+myURL); // functionality in CheckTitle.CheckErrorsComplete Method
		int flag =0;
		if (myURL.contains(".com.au"))
	...
	public void F_Test_ViewBrochures() throws Exception {
		myURL="http://"+myEnv+".holden.co.nz/forms/view-brochures?Vehicle="+myVehicle;
		driver.get(myURL);//testname= name.getMethodName();System.out.println(testname);
		WriteToFile.myWriteAppend(errorlog,"Scanning for 404,500, Redirection and network errors on Forms for new vehicle: "+myURL); // functionality in CheckTitle.CheckErrorsComplete Method
		int flag =0;
		if (myURL.contains(".com.au"))
